...
import static com.example.rdu.booklisting.BookActivity.LOG_TAG;
...
public final class QueryUtils {
    ...
    //Returns a list of Book objects from the JSON parsing
        ...
        try {
            ...
            for (int i = 0; i < booksArray.length(); i++) {
                ...
                if (authorsArray.length() > 1) {
                    ...
                    authors = authorsArray.optString(0, "Author Unspecified");
                }
